    ...
    private static ServerSocketFactory getServerSocketFactory(String type) {
        if (type.equals("TLS")) {
            ...
            try { // set up key manager to perform server authentication
                ...
                ks.load(new FileInputStream("projekt1/serverkeystore"), password);  // keystore password (storepass)
                ts.load(new FileInputStream("projekt1/servertruststore"), password); // truststore password (storepass)
